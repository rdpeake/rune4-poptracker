-- GENERATED by tools/apworld/export_location_meta.py from the Rune Factory 4 apworld.
-- Do not edit by hand; re-run the exporter against the apworld source instead.
-- Shipment, chest and tame rows come straight from the apworld's CSVs; friendship,
-- outfit, region-tier and absent ids are generated, and are all checked against
